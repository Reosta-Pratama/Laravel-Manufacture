            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Datatable Products Manufacture</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Datatable Products</li>
                                </ol>
                            </div>
                        </div>
                        <!-- /.row -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Datatable Products Manufacture</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="not-export-col">
                                                        <div class="btn-group-vertical">
                                                            <a class="btn btn-info" href="{{url('/dashboard/manufacture/dataTableProducts/editProduct/'.$item->nama)}}">Edit</a>
                                                            <a class="btn btn-danger" href="{{url('/dashboard/manufacture/dataTableProducts/deleteProduct/'.$item->id)}}">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
