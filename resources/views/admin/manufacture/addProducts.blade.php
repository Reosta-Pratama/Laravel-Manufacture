                        ...
                        <ul
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('dashboard.entry.product') }}" class="nav-link active">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('manufacture.entry.product') }}" class="nav-link active" >
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Entry Data Product</p>
                                        </a>
                                    </li>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Entry Data Product Manufacture</h1>
                            </div>
                            <div class="col-sm-6">
                ...
                <section class="content mb-5">
                    <div class="container-fluid">
                        <!-- /.row -->
                        <form
                            action="{{ route('manufacture.insert.product') }}"
                            id="quickForm"
                            method="POST"
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <textarea
                                                    ...
                                                    rows="4"
                                                    placeholder="Deksripsi Tambahan..."></textarea>
                                            </div>
