                        ...
                        <ul
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('manufacture.datatable.product') }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Datatables Product</p>
                                        </a>
                                    </li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content mb-5">
                    <div class="container-fluid">
                        <!-- /.row -->
                        <form
                            action="{{url('dashboard/dataTableProducts/saveProduct/'.$product->id)}}"
                            id="quickForm"
                            method="POST"
                            ...
                            <div class="row mb-5">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right py-0 align-middle">
                                                            <div class="btn-group btn-group-sm">
                                                                <a
                                                                    href="{{ asset($product->fotoTambahan1) }}"
                                                                    class="btn btn-info"
                                                                    data-toggle="lightbox">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                                    ...
                                                    @endif @if ($product->fotoTambahan2 != null)
                                                    <tr>
                                                        ...
                                                        <td class="text-right py-0 align-middle">
                                                            <div class="btn-group btn-group-sm">
                                                                <a
                                                                    href="{{ asset($product->fotoTambahan2) }}"
                                                                    class="btn btn-info"
                                                                    data-toggle="lightbox">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                                    ...
                                                    @endif @if ($product->fotoTambahan3 != null)
                                                    <tr>
                                                        ...
                                                        <td class="text-right py-0 align-middle">
                                                            <div class="btn-group btn-group-sm">
                                                                <a
                                                                    href="{{ asset($product->fotoTambahan3) }}"
                                                                    class="btn btn-info"
                                                                    data-toggle="lightbox">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                    ...
                                    <div class="card card-primary" style="height: 100%">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="old_image" value="{{$product->foto}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="deskripsi" class="form-control" name="deskripsi" rows="4">{{ $product->deskripsi}}
                                                </textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="card card-secondary" style="height: 100%">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="dekripsiTambahan">Deksripsi Tambahan</label>
                                                <textarea
                                                    id="dekripsiTambahan"
                                                    class="form-control"
                                                    name="dekripsiTambahan"
                                                    rows="4">{{ $product->dekripsiTambahan }}</textarea>
                                            </div>
