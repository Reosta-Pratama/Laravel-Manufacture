                        ...
                        <ul
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('dashboard.datatable.project') }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="not-export-col">
                                                        <div class="btn-group-vertical">
                                                            <a
                                                                class="btn btn-info"
                                                                href="{{url('/dashboard/dataTableProject/editProject/'.$item->nama)}}">Edit</a>
                                                            <a
                                                                class="btn btn-danger"
                                                                href="{{url('/dashboard/dataTableProject/deleteProject/'.$item->id)}}">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
