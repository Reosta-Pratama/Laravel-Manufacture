...
class ProductManufactureController extends Controller
{
    ...
    {
        $products = ProductManufacture::where('nama', 'LIKE', '%'.$request->keyword.'%');
        ...
        return view('Manufacture.products', compact('products'));
    }

    public function detail(Request $request)
    {
        $products = DB::table('product_manufactures')->where('nama', $request->nama)->first();

        return view('Manufacture.product-details', compact('products'));
    }

    
    public function showProducts(Request $request)
    {
        $products = ProductManufacture::all();
        if($request->keyword != ''){
          $products = ProductManufacture::where('nama','LIKE','%'.$request->keyword.'%')->get();
        }
    ...
    {
        return view('admin.manufacture.addProducts');
    }
    ...
    public function entryAdd(Request $request)
    {
        $validateData = $request -> validate([
            ...
            'nama' => 'required|unique:product_manufactures,nama',
            'kategori' => 'required',
            'deskripsi' => 'required'
        ]);
        ...
        $up_location = 'image/manufacture/product/';
    ...
    {
        $products = ProductManufacture::all();
        return view('admin.manufacture.datatableProduct', compact('products'));
    }

    public function editProduct(Request $request)
    {
        $product = DB::table('product_manufactures')->where('nama', $request->nama)->first();
        ...
        return view('admin.manufacture.detailProduct', compact('product','fotoSize', 'fotoSizefotoTambahan1', 'fotoSizefotoTambahan2', 'fotoSizefotoTambahan3'));
    }
    ...
    public function saveEdit(Request $request)
    {
        ...
        if ($foto) {
            ...
            if ($fotoTambahan1) {
                ...
                ProductManufacture::find($request->id)->update([
        ...
        return redirect() -> route('manufacture.datatable.product') -> with($notification);
    }

    public function deleteProduct($id){
        $image = ProductManufacture::find($id);
