...
class ProjectContructionController extends Controller
{
    //
    public function index(Request $request){
        $projects = ProjectContruction::where('nama', 'LIKE', '%'.$request->keyword.'%');
        switch (request('sortBy')) {
            ...
            case 'namaDES':
                ...
                break;
            // case 'NIKKEN':
            //     $projects->where('kategori', 'NIKKEN');
            //     break;
            default:
        ...
        return view('Contruction.projects', compact('projects'));
    }

    public function detail(Request $request){
        $projects = DB::table('project_contructions')->where('id', $request->id)->first();
        return view('Contruction.project-detail', compact('projects'));
    }

    public function entryPage()
    {
        return view('admin.contruction.addProjects');
    }
    ...
    public function entryAdd(Request $request)
    {
        $validateData = $request -> validate([
            ...
            'nama' => 'required|unique:project_contructions,nama',
            'kategori' => 'required',
            'deskripsi' => 'required',
            'tanggal' => 'required'
        ]);
        ...
        $up_location = 'image/construction/project/';
    ...
    {
        $projects = ProjectContruction::all();
        return view('admin.contruction.datatableProject',compact('projects'));
    }

    public function editProject(Request $request)
    {
        $project = DB::table('project_contructions')->where('nama', $request->nama)->first();
        ...
        return view('admin.contruction.detailProject', compact('project','fotoSize', 'fotoSizefotoTambahan1', 'fotoSizefotoTambahan2', 'fotoSizefotoTambahan3'));
    }
    ...
    public function saveEdit(Request $request)
    {
        ...
        $product = DB::table('project_contructions')->where('nama', $request->nama)->first();
        ...
        if ($foto) {
            ...
            if ($fotoTambahan1) {
                ...
                ProjectContruction::find($request->id)->update([
            ...
            $up_location = 'image/construction/tanggal/';
        ...
        return redirect() -> route('dashboard.datatable.project') -> with($notification);
    }

    public function deleteProject($id)
    {
        $image = ProjectContruction::find($id);
        ...
        if ($old_image != null) {
            ...
            ProjectContruction::find($id) -> delete();
            $notification = array(
